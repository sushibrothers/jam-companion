...
if st.session_state.get('analysis_done', False):
    ...
    st.write("Selecciona cualquier acorde detectado en la canción para ver exactamente qué notas tocar en el mástil:")
    
    if st.session_state.get('unique_chords'):
        selected = st.selectbox("Elige un acorde:", st.session_state['unique_chords'])
        if selected:
